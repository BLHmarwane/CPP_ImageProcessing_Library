...
#include <limits>
#include <cmath>
#include <cstdint> // Inclusion pour uint8_t, uint16_t, etc.
...
// Implémentation des méthodes de la classe template Image<T>
...
// Implémentation des méthodes de la classe ImageRGB
